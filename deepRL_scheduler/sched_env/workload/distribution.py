...
from deepRL_scheduler.sched_env.job import Job, JobParameters
from deepRL_scheduler.sched_env.workload.base import WorkloadGenerator
...
class BinomialWorkloadGenerator(DistributionalWorkloadGenerator):
    ...
    def __init__(
            ...
            new_job_rate,
            small_job_chance,
            small_job_parameters,
            large_job_parameters,
            length=0,
