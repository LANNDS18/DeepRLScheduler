...
class HPCEnv(Env):
    ...
    def schedule_curr_sequence_reset(self, score_fn):
        ...
        while True:
            ...
            # if f: num_total += 1 if selected job needs more resources, skip scheduling and try again after adding
            # new jobs or releasing some resources
    ...
    def step(self, a):
        ...
        if not done:
            ...
            return [None, rwd, True,
                    {'best_total': best_total, 'rl_total': rl_total, 'sjf': sjf, 'f1': f1, 'rwd2': rwd2}]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--workload', type=str,
                        default="../../deepRL_scheduler/dataset/NASA-iPSC-1993-3.1-cln.swf")  # RICC-2010-2
