...
from constants import EX4_PENDULUM_CONSTANTS as PENDULUM_CONSTANTS
from constants import EX4_BIPEDAL_CONSTANTS as BIPEDAL_CONSTANTS
...
PENDULUM_CONFIG = {
    ...
    "critic_hidden_size": [512, 256, 64, 32],
    "policy_hidden_size": [512, 256, 64, 32],
    "tau": 0.01,
    "batch_size": 64,
...
BIPEDAL_HPARAMS = {
    "critic_hidden_size": [[300, 300], [400, 400], [512, 256]],  # [[64, 64, 64], [128, 128, 128]]
    "policy_hidden_size": [[300, 300], [400, 400], [512, 256]],  # [[64, 64, 64], [128, 128, 128]]
    }
